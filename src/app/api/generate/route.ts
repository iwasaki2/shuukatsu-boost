...
{
  "esSelfPR": "【自己PR】200〜250字。強みと具体的エピソード、${companyName}での活かし方を含める",
  "esAppealPoints": "【アピールポイント】200〜250字。ガクチカや経験をもとに、この企業・職種で特にアピールできる強みや資質を具体的に記述",
  "esMotivation": "【志望理由】200〜250字。企業研究情報を具体的に引用し、志望の根拠を明確に記述"
}`;
    } else {
